...
public class StringMatchers {
	...
	/**
	 * Matcher to determine if a string starts with the provided string Example:
	 * assertThat("Aaron Loes", startsWith("Aaron"));
	 */
	...
	/**
	 * Matcher to determine if a string contains the provided string Example:
	 * assertThat("Aaron Loes", contains("on"));
	 */
	...
	/**
	 * Matcher to determine if a string ends with the provided string Example:
	 * assertThat("Aaron Loes", endsWith("Loes"));
	 */
