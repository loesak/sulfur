...
/**
 * Properties class that contains general execution properties for Selenese,
 * Selenium, and WebDriver based tests.
 * 
 * @author Aaron Loes
 */
public class ExecutionProperties {
	private static final String BASE_PROPERTY_FILE_PATH = "com/loesoft/sulfur/core/execution.properties";
	...
	/**
	 * retrieves the value of the application base url equivalent to
	 * ExecutionProperties.get("application.base.url");
	 * 
	...
	/**
	 * retrieves the value of the selenium server host equivalent to
	 * ExecutionProperties.get("selenium.server.host");
	 * 
	...
	/**
	 * retrieves the value of the selenium server port equivalent to
	 * ExecutionProperties.get("selenium.server.port");
	 * 
